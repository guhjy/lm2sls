...
The values of the exogenous variables are real, while those of the endogenous variables were simulated according to the model, with the following assumed values of the parameters:
\begin{align}
...
The structural equations may be estimated as follows by the `lm2sls()` function:
```{r}
